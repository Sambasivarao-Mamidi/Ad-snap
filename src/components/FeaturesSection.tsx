        ...
        >
          {additionalFeatures.map((feature, index) => {
            ...
            return (
              <motion.div
                key={feature.title}
                className="flex items-center gap-4 p-6 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all duration-300"
